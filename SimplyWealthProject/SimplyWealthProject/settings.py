"""
Django settings for SimplyWealthProject project.
...
SECRET_KEY = "django-insecure-5xz9v1o74pf01-tdrsd^=)5cq(2le%i&q*3i_q+*3(6q98fewh"
...
WSGI_APPLICATION = "SimplyWealthProject.wsgi.application"
